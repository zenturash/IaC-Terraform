...
backup_configuration = {
  ...
  # Custom backup policies (temporarily disabled for troubleshooting)
  # Will re-enable once basic backup infrastructure is working
  custom_backup_policies = {
    # Temporarily disabled to isolate the backup policy issue
    # The basic VM daily backup policy works fine
    # Custom policies will be re-enabled after troubleshooting
  }
}
